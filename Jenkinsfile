pipeline{
    ...
    stages{
        ...
        stage('Unit and Integration Tests'){
            steps{
                echo "In this stage, individual units or components of a software application are tested independently 
                to ensure they are worked as expected."
                echo "In the integration test, we ensure that all the components are worked together as expected and 
                verify that connection between each components in the software application. "
                echo "Unit Testing Tools - Selenium"
            }
        }
        stage('Code Analysis'){
            steps{
                echo "During this stage, integrate a code analysis tool to analyse the code quality 
                and check the code standards"
        ...
        stage('Integration Tests on Staging'){
            steps{
                echo "After deployment, identify any performance issues and 
